...
# python merge_peft_adapter.py --base_model_name="../model_cache/SeaLLMs-v3-7B" --adapter_model_name="dpo_output_SeaLLMs-v3-7B/final_checkpoint/" --output_name="ojk-final-model"
